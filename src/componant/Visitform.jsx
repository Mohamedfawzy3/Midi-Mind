...
const Visitform = () => {
  ...
  const save_tahalil = (e) => {
    ...
    e.preventDefault();
    axios
      .post("https://localhost:7189/api/RequierdTests", tahalil, {
        headers: {
  ...
  const save_ashea = (e) => {
    ...
    axios
      .post("https://localhost:7189/api/RequierdScans", ashea, {
        headers: {
          token: localStorage.getItem("token"),
        },
      })
  ...
  const save_rosheta = (e) => {
    ...
    e.preventDefault();
    axios
      .post("https://localhost:7189/api/PatientsVisitClinics", RoshetaInForm, {
        headers: {
      ...
      .catch((err) => setRosheta_btn_apperance(""));
  };
  return (
