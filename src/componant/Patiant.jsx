...
const Patiant = () => {
  ...
  const getPatiantInfo = () => {
    axios
      .get(`https://midimind.runasp.net/api/Patient/id?id=${id}`)
      .then((res) => {
        setPatient(res.data);
        console.log(patient)
  ...
  const get_notes = () => {
    axios
      .get(`https://midimind.runasp.net/api/PatientNotes/${id}`)
      .then((res) => {
  ...
  const postNote = (e) => {
    ...
    axios
      .post("https://midimind.runasp.net/api/PatientNotes", NewNote)
      .then((res) => {
        setReload(res.data)
        console.log(res);
...
const git_blood_presure=()=>{
  ...
  axios.get(`https://midimind.runasp.net/api/PatientBloodPressures/${id}`)
  .then(res=>{
...
const git_suger=()=>{
  axios.get(`https://midimind.runasp.net/api/PatientBloodSugers/${id}`)
  .then(res=>{
    const index=res.data.length-1
    const element=res.data[index]
