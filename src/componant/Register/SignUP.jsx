...
const SignUP = () => {
  ...
  const [city, setCity] = useState([
    [ 'اغاخان', 'الازبكية', 'الازهر', 'الاميرية', 'البساتين', 'التبين', 'الجزيرة', 
      'الجمالية', 'الحرفيين', 'الحسين', 'الحلمية', 'الحلمية الجديدة', 'الخليفة', 
      'الدراسة', 'الدرب الاحمر', 'الروضة', 'الزاوية الحمراء', 'الزمالك', 'الزيتون', 
      'الساحل', 'السبتية', 'السكاكينى', 'السواح', 'السيدة زينب', 'السيدة عائشة', 
      'السيدة نفيسة', 'الشرابية', 'الظاهر', 'العتبة', 'الفجالة', 'الفسطاط', 
      'القاهرة الجديدة', 'القبة الجديدة', 'القطامية', 'المرج', 'المرج الجديدة', 
      'المطرية', 'المعادى', 'المعصرة', 'المقطم', 'الملك الصالح', 'المنيرة', 'المنيل', 
      'الموسكى', 'النزهة الجديدة', 'الهايكستب', 'الوايلى', 'باب الخلق', 'باب الشعرية', 
      'باب اللوق', 'بولاق', 'اغاخان', 'الازبكية', 'الازهر', 'الاميرية', 'البساتين', 'التبين', 'الجزيرة', 
    'الجمالية', 'الحرفيين', 'الحسين', 'الحلمية', 'الحلمية الجديدة', 'الخليفة', 
    'الدراسة', 'الدرب الاحمر', 'الروضة', 'الزاوية الحمراء', 'الزمالك', 'الزيتون', 
    'الساحل', 'السبتية', 'السكاكينى', 'السواح', 'السيدة زينب', 'السيدة عائشة', 
    'السيدة نفيسة', 'الشرابية', 'الظاهر', 'العتبة', 'الفجالة', 'الفسطاط', 
    ...
    'المطرية', 'المعادى', 'المعصرة', 'المقطم', 'الملك الصالح', 'المنيرة', 'المنيل', 
    'الموسكى', 'النزهة الجديدة', 'الهايكستب', 'الوايلى', 'باب الخلق', 'باب الشعرية', 
    'باب اللوق', 'بولاق', 'جاردن سيتى', 'جسر السويس', 'حدائق الزيتون', 'حدائق القبة', 
    'حدائق حلوان', 'حلمية الزيتون', 'حلوان', 'حمامات القبة', 'خان الخليلى', 'دار السلام', 
    'رملة بولاق', 'روض الفرج', 'سراى القبة', 'شبرا', 'شبرا', 'شق الثعبان', 'طره', 
    'طريق القاهرة السويس', 'طريق مصر الاسماعيلية الصحراوى', 'عابدين', 'عباسية', 
    'عزبة النخل', 'عين الصيرة', 'عين شمس', 'عين شمس الشرقية', 'عين شمس الغربية', 
    'غمره', 'فم الخليج', 'قصر العينى', 'قلعة', 'كفر العلو', 'كوبرى القبة', 'كوتسيكا', 
    'لاظوغلى', 'مؤسسة الزكاة', 'مدينة 15 مايو', 'مدينة الرحاب', 'مدينة السلام', 
    'مدينة الشروق', 'مدينة بدر', 'مدينة قباء', 'مدينة نصر', 'مدينة نصر', 'مدينتى', 
    'مصر الجديدة', 'مصر الجديده', 'مصر القديمة', 'منشية ناصر', 'منيل الروضة','وادى حوف','وسط البلد'],
    [10, 30],
    ["ابو النمرس",
    "ابو رواش",
    "اطفيح",
...
,
  ...
  const AddUser=()=>{
    ...
    axios.post("https://localhost:7189/Auth/register",user_info)
    .then(res=>{
     console.log(res)
